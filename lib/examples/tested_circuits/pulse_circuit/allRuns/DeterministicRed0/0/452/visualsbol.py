...
part10 = {'type':'CDS', 'fwd':True, 'opts':{'linewidth':lw, 'label':'LasR', 'label_y_offset':-14, 'label_size':2,  'color':(1.00, 0.75, 0.17), 'edge_color':(0.00, 0.00, 0.00),'x_extent':20}}
...
part12 = {'type':'Promoter', 'fwd':True, 'opts':{'linewidth':lw, 'label':'pLas007', 'label_y_offset':-14, 'label_size':2,  'color':(1.00, 0.75, 0.17), 'edge_color':(0.00, 0.00, 0.00)}}
...
fig.savefig('/home/prash/cidar/phoenix/alpha/lib/examples/tested_circuits/pulse_circuit/allRuns/DeterministicRed0/0/452/circuit.png', dpi=1200)
plt.close('all')