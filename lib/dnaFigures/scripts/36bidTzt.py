...
design = [part0]
# Arc definitions
reg0 = {'type': 'Activation','from_part':part0, 'to_part':null, 'opts':{'color':(0.0,0.0,0.0), 'linewidth':lw, 'arc_height':20.0}}
regDesign = [reg0]
...
fig.savefig('/home/prash/cidar/phoenix/alpha/lib/dnaFigures/plots/36bidTzt.png', dpi=300)
plt.close('all')