...
part0 = {'type':'Promoter', 'fwd':True, 'opts':{'linewidth':lw, 'color':(0.05,0.09,0.85), 'edge_color':(0.00, 0.00, 0.00)}}
part1 = {'type':'RBS', 'fwd':True, 'opts':{'linewidth':lw, 'color':(0.0,0.0,0.0), 'edge_color':(0.00, 0.00, 0.00)}}
part2 = {'type':'CDS', 'fwd':True, 'opts':{'linewidth':lw, 'color':(1.00,1.00,1.00), 'edge_color':(0.00, 0.00, 0.00),'x_extent':20}}
...
fig.savefig('/home/prash/cidar/phoenix/alpha/lib/dnaFigures/plots/i8KcoyHd.png', dpi=300)
plt.close('all')